            ...
            <div class="flex flex-col md:flex-row pb-4 mb-4">
              ...
              <div class="mb-3 space-y-2 w-full text-xs">
                      ...
                      <div class="flex flex-wrap items-stretch w-full mb-4 relative">
                        ...
                        <input v-model="plop.facebook" id="facebook" type="text" class="flex-shrink flex-grow flex-auto leading-normal w-px border border-l-0 h-10 border-grey-light rounded-lg rounded-l-none px-3 relative focus:border-blue focus:shadow" placeholder="https://">
                          </div>
              </div>
              ...
              <div class="mb-3 space-y-2 w-full text-xs">
                     ...
                     <div class="flex flex-wrap items-stretch w-full mb-4 relative">
                        ...
                        <input v-model="plop.instagram" id="instagram" type="text" class="flex-shrink flex-grow flex-auto leading-normal w-px border border-l-0 h-10 border-grey-light rounded-lg rounded-l-none px-3 relative focus:border-blue focus:shadow" placeholder="https://">
                     </div>
              </div>
