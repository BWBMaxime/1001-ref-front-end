                    ...
                    <div class="tab-content">
                        <div class="pl-8 pr-8 pb-5 text-grey-darkest">
                            <form class="space-y-4 text-gray-700">
                                ...
                                <!--Adresse postale-->
                                <div class="w-64 font-bold h-6 mx-2 mt-3 text-gray-500">Adresse</div>
                                <div class="flex flex-col md:flex-row pb-4 mb-4">
                                    <div class="flex-1">
                                        <div class="flex flex-col md:flex-row">
                                            <div class="w-full flex-1 mx-2">
                                                <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                                    <input v-model="user.address.number" placeholder="Numéro" class="p-1 px-2 appearance-none outline-none w-full text-gray-800 "> 
                                                </div>
                                            </div>
                                            <div class="w-full flex-1 mx-2">
                                                <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                                    <input v-model="user.address.road" placeholder="Rue" class="p-1 px-2 appearance-none outline-none w-full text-gray-800 "> 
                                                </div>
                                            </div>
                                            <div class="w-full flex-1 mx-2">
                                                <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                                    <input v-model="user.address.zipcode" placeholder="Code Postal" class="p-1 px-2 appearance-none outline-none w-full text-gray-800 ">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="flex flex-col md:flex-row pb-4 mb-4">
                                    <div class="flex-1">
                                        <div class="flex flex-col md:flex-row">
                                            <div class="w-full flex-1 mx-2">
                                                <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                                    <input v-model="user.address.city" placeholder="Ville" class="p-1 px-2 appearance-none outline-none w-full text-gray-800 ">
                                                </div>
                                            </div>
                                            <div class="w-full flex-1 mx-2">
                                                <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                                    <input v-model="user.address.country" placeholder="Pays" class="p-1 px-2 appearance-none outline-none w-full text-gray-800 ">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
