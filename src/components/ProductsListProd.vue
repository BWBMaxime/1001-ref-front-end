                ...
                <table class="w-full border-separate place-self-center">
                    ...
                    <thead class="opacity-80 bg-yellow-500 flex text-white w-full">
                        <tr class="flex w-full text-center">
                            ...
                            <th class="px-4 py-3 w-24">Promotion</th>
                    ...
                    <tbody class="bg-white items-center">
                        <div v-for="product in products" v-bind:key="product">
                            <tr class="text-gray-700 h-auto" v-for="variation in product.variations" v-bind:key="variation">
                                ...
                                <!-- Price -->
                                <td class="mx-4 my-3 w-36 text-sm border text-center">{{ variation.prixRevendeur }} €</td>
                                <!-- New -->
                                <td v-if="product.new == true" class="mx-4 my-3 w-24 text-sm border text-center">
                                ...
                                <!-- Promo -->
                                <td v-if="product.promo == true" class="mx-4 my-3 w-24 text-sm border text-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                </td>
...
export default {
    ...
    methods:{
        getAllProductsByUserId(){
            ProductController.getCurrentUserProducts(1);
        },
