...
const UserController = {
    ...
    saveUser(user) {
        ...
        axios.post('http://localhost:46691/register', JSON.stringify(user), {withCredentials:false})
...
,
      ...
      checkLogs(credentials) {
        ...
        axios.post('http://localhost:46691/getCred', logs, {withCredentials:false})
     ...
     */
    updateUser(user) {
        axios.post('http://127.0.0.1:46691/user/update', JSON.stringify(user), {withCredentials:false})
        .then(function(response){
    ...
    getUser(ID, user) {
        axios.get('http://127.0.0.1:46691/user/get/' + ID, {withCredentials:false})
        .then(function(response){
